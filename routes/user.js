...
exports.showBidHistory = function(req, res) {
	...
	var sql = "SELECT * from Bid b, Customer c, Person pe, Product p where b.Bid_customer_id=c.Customer_id and c.Person_id=pe.Person_id and b.Bid_product_id=p.Product_id and pe.Person_id="+id;
	db.fetchData(function(err, result){
		if (err){
